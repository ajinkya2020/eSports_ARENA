    ...
    private void resetPassword()
    {
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(ForgotPassword.this, "Check your mail for the reset password link", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(ForgotPassword.this, "A failure occurred!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
